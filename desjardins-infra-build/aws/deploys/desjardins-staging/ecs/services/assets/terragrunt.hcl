...
inputs = {
  ...
  container_image = "738001968068.dkr.ecr.ca-central-1.amazonaws.com/desjardins-staging-assetstore:stable-tdr-10"
  container_command = [ ]
...
dependency "this_lb" {
  config_path = "../../..//ec2/load_balancers/assets"
}

dependency "this_sg" {
  config_path = "../../..//ec2/security_groups/assets/svc"
}
