...
inputs = {
  ...
  container_image = "738001968068.dkr.ecr.ca-central-1.amazonaws.com/desjardins-staging-membersite:desjardins-prod-v2.0.7.33-84"
  container_command = [ ]
...
dependency "this_lb" {
  config_path = "../../..//ec2/load_balancers/members"
}

dependency "this_sg" {
  config_path = "../../..//ec2/security_groups/members/svc"
}
