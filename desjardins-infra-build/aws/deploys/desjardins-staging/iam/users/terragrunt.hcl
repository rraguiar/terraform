...
inputs = {
  ...
  group_names = {
    developer = dependency.this_groups.outputs.group_developer.name,
    readonly  = dependency.this_groups.outputs.group_readonly.name,
    superuser = dependency.this_groups.outputs.group_superuser.name,
  }
}
