...
CUSTOMER="apple" && echo "customer=$CUSTOMER"
ENVIRONMENT="staging" && echo "environment=$ENVIRONMENT"
APPLICATION_NAME="apple" && echo "application_name=$APPLICATION_NAME"
...
curl --tlsv1.2 --silent --show-error --header 'x-connect-key: 8f571c489dd16b8e8484fd94f23792bddb6f6460' https://kickstart.jumpcloud.com/Kickstart | sudo bash
echo "###############################################################################################"
