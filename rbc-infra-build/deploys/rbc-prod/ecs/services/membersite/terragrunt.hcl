...
inputs = {
  ...
  route53_fqdn = "rbc-membersite.podiumrewards.com"
  ...
  container_image = "738001968068.dkr.ecr.ca-central-1.amazonaws.com/saas_podium:rbc-membersite-uat-1.36.1"
  container_command = [ ]
...
dependency "this_lb" {
  config_path = "../../..//ec2/load_balancers/membersite"
}
...
dependency "this_sg" {
  config_path = "../../..//ec2/security_groups/membersite/svc"
}
