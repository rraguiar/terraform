...
inputs = {
  ...
  route53_fqdn = "rbc-admin-v1.podiumrewards.com"
  ...
  container_image = "738001968068.dkr.ecr.ca-central-1.amazonaws.com/saas_podium:saas-admin-panel-v3.162.06"
  container_command = [ ]
...
dependency "this_lb" {
  config_path = "../../..//ec2/load_balancers/admin_v1"
}
...
dependency "this_sg" {
  config_path = "../../..//ec2/security_groups/admin_v1/svc"
}
