...
inputs = {
  ...
  container_image = "738001968068.dkr.ecr.ca-central-1.amazonaws.com/saas_extended:scheduler-v1.18.05-c74fd96"
...
dependency "this_sg" {
  config_path = "../../..//ec2/security_groups/extended_scheduler/svc"
}
