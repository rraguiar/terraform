...
inputs = {
  ...
  container_image = "738001968068.dkr.ecr.ca-central-1.amazonaws.com/saas_extended:listener-v1.18.05-c74fd96"
  container_command = [ "sh","/usr/local/bin/entrypoint.sh" ]
  ...
  container_secrets = [
    ...
    {
      name = "DB_PASSWORD",
      valueFrom = dependency.this_secrets.outputs.arns["rbc/prod/extended/db_admin_password"],
    },
    {
      name = "REDIS_HOST",
...
dependency "this_sg" {
  config_path = "../../..//ec2/security_groups/extended_listener/svc"
}
