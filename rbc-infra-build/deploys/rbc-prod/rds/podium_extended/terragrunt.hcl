...
inputs = {
  ...
  db_admin_password_secret = dependency.this_secrets.outputs.names["rbc/prod/db_admin_password"]
  db_name_secret = dependency.this_secrets.outputs.names["rbc/prod/db_database"]
